...
def test_keep_width_true():
    ...
    assert(friendly_bytes( 212321 , keep_width=True) == ' 212.32 KB ')
    assert(friendly_bytes( 424642 , keep_width=True) == ' 424.64 KB ')
    assert(friendly_bytes( 636963 , keep_width=True) == ' 636.96 KB ')
    assert(friendly_bytes( 849284 , keep_width=True) == ' 849.28 KB ')
    assert(friendly_bytes( 1061605 , keep_width=True) == ' 1.06000 MB ')
    assert(friendly_bytes( 1273926 , keep_width=True) == ' 1.27000 MB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 45450 , keep_width=True) == ' 45.45 KB ')
    assert(friendly_bytes( 90900 , keep_width=True) == ' 90.90 KB ')
    assert(friendly_bytes( 136350 , keep_width=True) == ' 136.35 KB ')
    assert(friendly_bytes( 181800 , keep_width=True) == ' 181.80 KB ')
    assert(friendly_bytes( 227250 , keep_width=True) == ' 227.25 KB ')
    assert(friendly_bytes( 272700 , keep_width=True) == ' 272.70 KB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 903428347234 , keep_width=True) == ' 903.42000000 GB ')
    assert(friendly_bytes( 1806856694468 , keep_width=True) == ' 1.80000000000 TB ')
    assert(friendly_bytes( 2710285041702 , keep_width=True) == ' 2.71000000000 TB ')
    assert(friendly_bytes( 3613713388936 , keep_width=True) == ' 3.61000000000 TB ')
    assert(friendly_bytes( 4517141736170 , keep_width=True) == ' 4.51000000000 TB ')
    assert(friendly_bytes( 5420570083404 , keep_width=True) == ' 5.42000000000 TB ')
    assert(friendly_bytes( 0.0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 238942.443 , keep_width=True) == ' 238.94 KB ')
    assert(friendly_bytes( 477884.886 , keep_width=True) == ' 477.88 KB ')
    assert(friendly_bytes( 716827.329 , keep_width=True) == ' 716.82 KB ')
    assert(friendly_bytes( 955769.772 , keep_width=True) == ' 955.76 KB ')
    assert(friendly_bytes( 1194712.215 , keep_width=True) == ' 1.19000 MB ')
    assert(friendly_bytes( 1433654.658 , keep_width=True) == ' 1.43000 MB ')
    assert(friendly_bytes( 0.0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 8343493409.22212 , keep_width=True) == ' 8.34000000 GB ')
    assert(friendly_bytes( 16686986818.44424 , keep_width=True) == ' 16.68000000 GB ')
    assert(friendly_bytes( 25030480227.66636 , keep_width=True) == ' 25.03000000 GB ')
    assert(friendly_bytes( 33373973636.88848 , keep_width=True) == ' 33.37000000 GB ')
    assert(friendly_bytes( 41717467046.1106 , keep_width=True) == ' 41.71000000 GB ')
    assert(friendly_bytes( 50060960455.33272 , keep_width=True) == ' 50.06000000 GB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 840933049 , keep_width=True) == ' 840.93000 MB ')
    assert(friendly_bytes( 1681866098 , keep_width=True) == ' 1.68000000 GB ')
    assert(friendly_bytes( 2522799147 , keep_width=True) == ' 2.52000000 GB ')
    assert(friendly_bytes( 3363732196 , keep_width=True) == ' 3.36000000 GB ')
    assert(friendly_bytes( 4204665245 , keep_width=True) == ' 4.20000000 GB ')
    assert(friendly_bytes( 5045598294 , keep_width=True) == ' 5.04000000 GB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    ...
    assert(friendly_bytes( 0.0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 483434093 , keep_width=True) == ' 483.43000 MB ')
    assert(friendly_bytes( 966868186 , keep_width=True) == ' 966.86000 MB ')
    assert(friendly_bytes( 1450302279 , keep_width=True) == ' 1.45000000 GB ')
    assert(friendly_bytes( 1933736372 , keep_width=True) == ' 1.93000000 GB ')
    assert(friendly_bytes( 2417170465 , keep_width=True) == ' 2.41000000 GB ')
    assert(friendly_bytes( 2900604558 , keep_width=True) == ' 2.90000000 GB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    ...
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 122133 , keep_width=True) == ' 122.13 KB ')
    assert(friendly_bytes( 244266 , keep_width=True) == ' 244.26 KB ')
    assert(friendly_bytes( 366399 , keep_width=True) == ' 366.39 KB ')
    assert(friendly_bytes( 488532 , keep_width=True) == ' 488.53 KB ')
    assert(friendly_bytes( 610665 , keep_width=True) == ' 610.66 KB ')
    assert(friendly_bytes( 732798 , keep_width=True) == ' 732.79 KB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 328939324239329234 , keep_width=True) == ' 328.93000000000000 PB ')
    assert(friendly_bytes( 657878648478658468 , keep_width=True) == ' 657.87000000000000 PB ')
    assert(friendly_bytes( 986817972717987702 , keep_width=True) == ' 986.81000000000000 PB ')
    assert(friendly_bytes( 1315757296957316936 , keep_width=True) == ' 1.31000000000000000 EB ')
    assert(friendly_bytes( 1644696621196646170 , keep_width=True) == ' 1.64000000000000000 EB ')
    assert(friendly_bytes( 1973635945435975404 , keep_width=True) == ' 1.97000000000000000 EB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 3434904393490 , keep_width=True) == ' 3.43000000000 TB ')
    assert(friendly_bytes( 6869808786980 , keep_width=True) == ' 6.86000000000 TB ')
    assert(friendly_bytes( 10304713180470 , keep_width=True) == ' 10.30000000000 TB ')
    assert(friendly_bytes( 13739617573960 , keep_width=True) == ' 13.73000000000 TB ')
    assert(friendly_bytes( 17174521967450 , keep_width=True) == ' 17.17000000000 TB ')
    assert(friendly_bytes( 20609426360940 , keep_width=True) == ' 20.60000000000 TB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 349823093209 , keep_width=True) == ' 349.82000000 GB ')
    assert(friendly_bytes( 699646186418 , keep_width=True) == ' 699.64000000 GB ')
    assert(friendly_bytes( 1049469279627 , keep_width=True) == ' 1.04000000000 TB ')
    assert(friendly_bytes( 1399292372836 , keep_width=True) == ' 1.39000000000 TB ')
    assert(friendly_bytes( 1749115466045 , keep_width=True) == ' 1.74000000000 TB ')
    assert(friendly_bytes( 2098938559254 , keep_width=True) == ' 2.09000000000 TB ')
    assert(friendly_bytes( 0.0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 332423.3232432 , keep_width=True) == ' 332.42 KB ')
    assert(friendly_bytes( 664846.6464864 , keep_width=True) == ' 664.84 KB ')
    assert(friendly_bytes( 997269.9697296 , keep_width=True) == ' 997.26 KB ')
    assert(friendly_bytes( 1329693.2929728 , keep_width=True) == ' 1.32000 MB ')
    assert(friendly_bytes( 1662116.6162160002 , keep_width=True) == ' 1.66000 MB ')
    assert(friendly_bytes( 1994539.9394592 , keep_width=True) == ' 1.99000 MB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 48234023409 , keep_width=True) == ' 48.23000000 GB ')
    assert(friendly_bytes( 96468046818 , keep_width=True) == ' 96.46000000 GB ')
    assert(friendly_bytes( 144702070227 , keep_width=True) == ' 144.70000000 GB ')
    assert(friendly_bytes( 192936093636 , keep_width=True) == ' 192.93000000 GB ')
    assert(friendly_bytes( 241170117045 , keep_width=True) == ' 241.17000000 GB ')
    assert(friendly_bytes( 289404140454 , keep_width=True) == ' 289.40000000 GB ')
    assert(friendly_bytes( 0.0 , keep_width=True) == ' 0 B ')
    ...
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 239023932 , keep_width=True) == ' 239.02000 MB ')
    assert(friendly_bytes( 478047864 , keep_width=True) == ' 478.04000 MB ')
    assert(friendly_bytes( 717071796 , keep_width=True) == ' 717.07000 MB ')
    assert(friendly_bytes( 956095728 , keep_width=True) == ' 956.09000 MB ')
    assert(friendly_bytes( 1195119660 , keep_width=True) == ' 1.19000000 GB ')
    assert(friendly_bytes( 1434143592 , keep_width=True) == ' 1.43000000 GB ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
    assert(friendly_bytes( 0 , keep_width=True) == ' 0 B ')
